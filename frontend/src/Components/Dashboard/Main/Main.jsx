...
const Greetings = ({ username }) => {
    ...
    useEffect(() => {
        ...
        else if(hour < 16 ) setGreeting('afternoon')
...
const Tracks = ({ title, number, num_color }) => {
    return (
        <div class="shadow-lg rounded-2xl w-full p-4 bg-white dark:bg-gray-800">
            ...
            <div class="flex flex-col justify-start">
                <p className={`${num_color} text-4xl text-left dark:text-white font-bold my-4`}>
                    { number }
                </p>
            </div>
        </div>
...
function Main({ username }) {
    ...
    return (
        <div className="flex flex-col w-full md:space-y-4">
                    {/*Header*/}
                <div className="overflow-auto h-screen pt-8 pb-24 px-4 md:px-6">
                    <Greetings username={username} />
                    <h2 className="text-2xl text-left dark:text-white my-4">Report</h2>
                    <div className="px-4 flex my-6 items-center justify-evenly w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row">
                        <Tracks title="Open" number="12" num_color="text-red-500" />
                        <Tracks title="In-progress" number="3" num_color="text-blue-500" />
                        <Tracks title="Closed" number="2" num_color="text-green-500" />
                    </div>
